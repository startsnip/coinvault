...
<body>
  ...
  <?php $count = 0; ?>
    ...
    <div class="no-gutters item unit one-fifth center-on-mobiles" style="<?php if($count % 5 == 0) { echo 'clear: both;'; } ?>">
      <a href="/dashboard/index.php?action=displayItem&amp;coinID=<?php echo $value['coinID']; ?>" title="<?php echo $value['year'] . " " . $value['coinName']; ?>"><img id="coin" src="<?php echo $value['coinImage']; ?>" alt="<?php $value['coinName']; ?>"></a>
